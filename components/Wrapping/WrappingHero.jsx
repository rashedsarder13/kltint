...
export default function WrappingHero() {
  return (
    <section className="relative h-screen lg:h-[130vh] overflow-hidden bg-[#0A0A0C] tint-hero-section">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/wrapping/hero-bg.png')" }}
      />
        ...
        <div className="w-full max-w-7xl mx-auto flex items-start gap-3 md:gap-6 lg:gap-8 mt-4 md:mt-8 lg:mt-10">
          ...
          <div className="flex-1 max-w-4xl">
            <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-[48px] uppercase font-bold font-oswald leading-[1.2] mb-3 md:mb-4 lg:mb-5 gradient-title">
              Transform Your Car With Endless Colors
            </h1>
            <p className="text-sm md:text-base lg:text-lg description-text">
              Without wrapping, you&apos;re stuck with limited OEM shades that
              look plain and unoriginal. Wrapping gives you thousands of premium
              finishes for a unique identity.
            </p>
          </div>
        </div>
      </div>
