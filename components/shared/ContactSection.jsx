...
export default function ContactSection() {
  ...
  return (
    <section
      className="contact-section relative  py-10 md:py-24 overflow-hidden bg-[#010101] h-[1160px] md:h-[1286px] opacity-100"
    ...
    >
      ...
      <div className="contact-wrapper relative z-10 max-w-[1777px] mx-auto px-[10px] md:px-[112px]">
        {/* Title */}
        <div
        ...
        >
          ...
          <div className="md:h-[64px] md:w-[696px] h-[34px] w-[400px] "
            style={{
              position: "absolute",
              background: "#032EBD",
              borderRadius: "50%",
        ...
        >
          ...
          >
            ...
            <form
              className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 mx-2 md:mx-0"
