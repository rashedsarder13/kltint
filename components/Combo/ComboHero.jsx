...
export default function ComboHero() {
  return (
    <section className="relative h-screen lg:h-[130vh] overflow-hidden bg-[#0A0A0C] combo-hero-section">
      {/* Background image */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat combo-hero-bg"
        style={{ backgroundImage: "url('/combo/hero-bg.svg')" }}
      />
      ...
      <div className="relative z-10 h-full flex items-start pt-24 md:pt-20 lg:pt-24 xl:pt-32 px-4 md:px-8 lg:px-12 combo-hero-content">
        <div className="w-full max-w-7xl mx-auto flex items-start gap-3 md:gap-6 lg:gap-8 mt-4 md:mt-8 lg:mt-10">
          ...
          <div className="flex-1 max-w-4xl">
            ...
            <p className="text-sm md:text-base lg:text-lg description-text">
              KL Tint Studio&apos;s Combo Packages combine our most popular
              services—Tinting, Coating, and PPF—into one affordable solution,
              saving you the hassle of coordinating multiple services from
              different shops
            </p>
          </div>
        </div>
      ...
      {/* Social Media Strip - Right Side (hidden on mobile) */}
      ...
      {/* Bottom Arrow */}
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10 combo-hero-arrow">
        <Image
      ...
      <style jsx>{`
        @media (max-width: 767px) {
          ...
          .combo-hero-content .flex-col {
            display: none !important;
          }

          .combo-hero-content h1 {
