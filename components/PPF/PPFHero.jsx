...
export default function PPFHero() {
  return (
    <section className="relative h-screen lg:h-[130vh] overflow-hidden bg-[#0A0A0C] ppf-hero-section">
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat ppf-hero-bg"
        style={{ backgroundImage: "url('/ppf/hero-bg.png')" }}
      />
      ...
      <div className="relative z-10 h-full flex items-start pt-24 md:pt-20 lg:pt-24 xl:pt-32 px-4 md:px-8 lg:px-12 ppf-hero-content">
        <div className="w-full max-w-7xl mx-auto flex items-start gap-3 md:gap-6 lg:gap-8 mt-4 md:mt-8 lg:mt-10">
          ...
          <div className="flex-1 max-w-4xl">
            <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-[48px] font-bold font-oswald leading-[1.2] mb-3 md:mb-4 lg:mb-5 gradient-title">
              Protect Your Car from Road Damage
            </h1>
            <p className="text-sm md:text-base lg:text-lg description-text">
              Without PPF, your car&apos;s paint takes direct hits from stone
              chips, road rash, and harsh etching from bird droppings or tree
              sap—leading to costly repainting and visible blemishes.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Arrow */}
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10 ppf-hero-arrow">
        <Image
