...
export default function GalleryContact() {
  ...
  return (
    <section
      id="contact"
      className="contact-section relative py-10 md:py-24 overflow-hidden bg-[#010101] h-[1160px] md:h-[1486px] opacity-100"
    >
      {/* Background image */}
      <div className="absolute inset-0">
        <Image
          src="/gallery/gallerycontact.svg"
          width={1777}
          height={1486}
          alt=""
      ...
      <div className="contact-wrapper relative z-10 max-w-[1777px] mx-auto px-[6px] md:px-[112px]">
        {/* Title */}
        <div
        ...
        >
          ...
          <div className="ellipse-bg md:h-[64px] md:w-[696px] h-[34px] w-[400px]"
            style={{
              position: "absolute",
              background: "#032EBD",
              borderRadius: "50%",
          ...
          />
          <h2
            className="contact-hero text-[32px] leading-[40px] md:text-[72px] md:leading-[72px]"
            style={{
              position: "relative",
              zIndex: 1,
        ...
        >
          ...
          >
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 mx-2 md:mx-0" onSubmit={handleSubmit}>
              {/* Name */}
              <div className="md:col-span-2 name-field">
                <label
              ...
              <div className="md:col-span-2 flex justify-center send-btn">
                <button type="submit" className="relative" disabled={status === "loading"} style={{ opacity: status === "loading" ? 0.7 : 1 }}>
                  <Image
                    ...
                    height={140}
                    alt="Send Now"
                    className="send-image hover:brightness-110 transition-all h-[150px] -mt-4 md:mt-0 md:h-auto"
                  />
                </button>
              </div>
            </form>
            ...
            <style jsx>{`
              ...
              /* Service dropdown (select) should be black with white text while inputs remain transparent */
              ...
              @media (min-width: 768px) {
                ...
                /* Make Name input span full width when its parent has .name-field */
                .name-field .contact-input {
                  max-width: 100%;
                }
              ...
              @media (max-width: 767px) {
                ...
                .contact-section {
                  ...
                  opacity: 1 !important; /* ensure full visibility on mobile */
                }
