...
<tr><td style="padding:9px 0; color:#9ca3af;">Subtotal</td><td align="right" style="padding:9px 0; color:#ffffff;">RM {{subtotal}}</td></tr>
{{promo_rows_customer}}
<tr><td style="padding:9px 0; color:#9ca3af;">Total Paid</td><td align="right" style="padding:9px 0; color:#fbbf24; font-weight:700;">RM {{total_paid}}</td></tr>
</table>
...
<tr><td style="color:#9ca3af;">Subtotal</td><td align="right">RM {{subtotal}}</td></tr>
{{promo_rows_admin}}
<tr><td style="color:#9ca3af;">Total Paid</td><td align="right" style="color:#fbbf24; font-weight:bold;">RM {{total_paid}}</td></tr>
</table>
</td></tr></table>
</td></tr></table>
</body>
